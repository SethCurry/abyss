...
// NewProxiedACPClient creates a new ProxiedACPClient with the given router.
...
// ProxiedACPClient implements acp.Client, but the backend is
// a websocket connection to a real client.
type ProxiedACPClient struct {
	router *wsrouter.ACPRouter
}

// RequestPermission implements acp.Client via a websocket
// connection to a real client.
...
// SessionUpdate implements acp.Client via a websocket
// connection to a real client.
...
// WriteTextFile implements acp.Client via a websocket
// connection to a real client.
...
// ReadTextFile implements acp.Client via a websocket
// connection to a real client.
...
// CreateTerminal implements acp.Client via a websocket
// connection to a real client.
...
// TerminalOutput implements acp.Client via a websocket
// connection to a real client.
...
// ReleaseTerminal implements acp.Client via a websocket
// connection to a real client.
...
// WaitForTerminalExit implements acp.Client via a websocket
// connection to a real client.
...
// KillTerminal implements acp.Client via a websocket
// connection to a real client.
func (e *ProxiedACPClient) KillTerminal(
